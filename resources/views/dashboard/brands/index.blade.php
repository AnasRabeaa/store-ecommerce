                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{__('admin/index.Brands')}}
                                    </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin/index.All Brands')}} </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <thead class="">
                                            <tr>
                                                <th>{{__('admin/index.Brand')}} </th>
                                                <th>{{__('admin/index.Status')}}</th>
                                                <th> {{__('admin/index.Language')}}</th>
                                                <th>{{__('admin/index.Brand Image')}}</th>
                                            ...
                                            @isset($brands)
                                                @foreach($brands as $brand)
                                                    <tr>
                                                        ...
                                                        <td>{{$brand->name}}</td>
                                                        <td>{{$brand->is_active == true ? 'Active' : 'Not active'}}</td>
                                                        <td>{{$brand->is_translatable == 1 ? 'EN & AR' : 'EN'}}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{--Update Link--}}
                                                        <a href="{{route('view-update-brand', $brand -> id)}}"
