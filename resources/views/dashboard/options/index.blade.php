        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{__('admin/sidebar.Attribute Options')}} </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/index.Dashboard')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{__('admin/sidebar.Attribute Options')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> {{__('admin/sidebar.Attribute Options')}} </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <thead class="">
                                            <tr>
                                                <th>{{__('admin/index.Option Name')}}</th>
                                                <th>{{__('admin/index.Price')}}</th>
                                                <th>{{__('admin/index.Product')}}</th>
                                                <th>{{__('admin/index.Attributes')}}</th>
