    ...
    <div class="app-content content">
        <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{__('admin/index.Add Sliders')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> {{__('admin/sidebar.Slider Images')}}  </h4>
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    <div class="card-text">
                        <p>{{__('admin/index.Current Photos')}}</p>
                    </div>
                </div>
                <div class="card-body  my-gallery" itemscope="" itemtype="http://schema.org/ImageGallery"
                    ...
                    <div class="row">
                        @isset($images)
                            ...
                            @empty
                                {{__('admin/index.There are no pictures at the moment')}}
                            @endforelse
                        @endisset
                    </div>
