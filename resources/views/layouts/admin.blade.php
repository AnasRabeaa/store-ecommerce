...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/'.getCssFile().'/core/menu/menu-types/vertical-menu.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/'.getCssFile().'/core/colors/palette-gradient.css')}}">
...
<script>
    ...
    var pusher = new Pusher('2e06a764b5e0976084bb', {
        encrypted: true
    });
